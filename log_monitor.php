...
$sendMail = function ($attachments) use ($now, $config)
{
    ...
    if (!empty($attachments)) {
        $subject = '[Log Monitor] ' . $now->format('Y-m-d H:i:s O');
        $message = 'This email was generated by the Log File Monitor. The attached file(s) have changed within the set timeframe. This report was generated at ' . $now->format('Y-m-d H:i:s O') . '.';
